        ...
        <main className="container mx-auto px-4 pb-20">
          ...
          <section className="text-center mb-20">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-psychology-primary via-psychology-secondary to-psychology-accent bg-clip-text text-transparent leading-tight">
                性压抑测试与指数计算器
                <span className="block text-xl sm:text-2xl md:text-3xl mt-3 text-muted-foreground/80 font-normal">Sexual Repression Test & Index Calculator</span>
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto px-2">
                专业的性心理健康自我评估工具，基于多个经过验证的心理测量量表，
                帮助您科学地了解自己的性心理特征，促进性健康和亲密关系的发展。
              </p>
              
              {/* 适应性评估亮点 */}
              <div className="bg-psychology-primary/5 border border-psychology-primary/20 rounded-xl p-5 md:p-6 mb-8 max-w-3xl mx-auto text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 w-full px-4 sm:px-0">
                <Link to="/assessment?type=quick" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto bg-psychology-primary hover:bg-psychology-primary/90 text-white px-8 py-6 sm:py-4 text-lg rounded-xl">
                ...
                <Link to="/assessment?type=full" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-psychology-primary text-psychology-primary hover:bg-psychology-primary/5 px-8 py-6 sm:py-4 text-lg rounded-xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
                ...
                <div className="text-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-psychology-secondary/10">
                ...
                <div className="text-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-psychology-accent/10">
                ...
                <div className="text-center p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-psychology-success/10">
          ...
          <section className="mb-20">
            <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-psychology-primary/10 shadow-sm">
                <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4">什么是性压抑指数 (What is the SRI?)</h2>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-psychology-secondary/10 shadow-sm">
                <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4 sm:mb-6">如何使用性压抑指数计算器 (How to Use the Calculator)</h2>
          ...
          <section className="mb-20">
            <div className="text-center mb-10 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">选择适合您的测评版本</h2>
          ...
          <section className="mb-20">
            <div className="text-center mb-10 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">科学可靠的评估基础</h2>
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4">
              ...
              <Card className="sri-card text-center">
                <CardContent className="p-5 sm:p-6">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Heart className="w-7 h-7 sm:w-8 sm:h-8 text-purple-600" />
                  </div>
              ...
              <Card className="sri-card text-center">
                <CardContent className="p-5 sm:p-6">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Brain className="w-7 h-7 sm:w-8 sm:h-8 text-green-600" />
                  </div>
          ...
          <section className="mb-20">
            <Card className="sri-card border-psychology-primary/20 bg-psychology-primary/5">
              <CardContent className="p-6 sm:p-8 text-center">
                <Shield className="w-12 h-12 sm:w-16 sm:h-16 text-psychology-primary mx-auto mb-4 sm:mb-6" />
                <h2 className="text-xl sm:text-2xl font-bold text-psychology-primary mb-3 sm:mb-4">您的隐私是我们的首要关注</h2>
          ...
          <section className="mb-20">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">常见问题解答 (FAQ)</h2>
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/80 p-5 sm:p-6 rounded-xl border border-psychology-primary/10">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2">这个性压抑指数计算器是免费的吗？</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">是的，我们的性压抑指数计算器完全免费。我们致力于为所有人提供科学、可靠的情感健康自我评估工具。</p>
                </div>
                <div className="bg-white/80 p-5 sm:p-6 rounded-xl border border-psychology-primary/10">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2">我的测试结果会被分享或保存吗？</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">绝对不会。所有的测试数据和结果都在您的浏览器本地处理，我们不会收集、存储或分享您的任何个人信息，确保100%的隐私安全。</p>
                </div>
                <div className="bg-white/80 p-5 sm:p-6 rounded-xl border border-psychology-primary/10">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2">测试结果准确吗？</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">我们的计算器基于多个经过验证的心理测量量表（如SIS/SES双控制模型、Mosher性内疚量表等）。虽然它能提供有价值的洞察，但请记住，它不能替代专业的心理咨询或医疗诊断。更多信息，请参阅我们的<Link to="/science" className="text-psychology-primary hover:underline">科学依据</Link>。</p>
                </div>
                <div className="bg-white/80 p-5 sm:p-6 rounded-xl border border-psychology-primary/10">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2">什么是 sexuality test？</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">Sexuality test 是一种帮助个人探索其性心理、性取向、性态度及情感反应的工具。我们的计算器专注于评估性压抑程度，帮助您更好地理解自己在亲密关系中的表现和潜意识情感。</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="text-center px-4 sm:px-0">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">准备好开始您的性心理健康之旅了吗？</h2>
              <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
                通过科学的自我评估，更好地了解自己，促进健康的性心理发展和亲密关系。
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
                <Link to="/assessment?type=quick" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto bg-psychology-primary hover:bg-psychology-primary/90 text-white px-8 py-6 sm:py-4 rounded-xl">
                    <Zap className="w-5 h-5 mr-2" />
                    立即开始测评
                  </Button>
                </Link>
                <Button size="lg" variant="outline" asChild className="w-full sm:w-auto border-psychology-primary text-psychology-primary hover:bg-psychology-primary/5 px-8 py-6 sm:py-4 rounded-xl">
                  <Link to="/guide">
